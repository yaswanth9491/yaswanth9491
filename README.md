...
##  💫 About Me:
I am a results-driven **Data Analyst** currently working at **Two Hungry Boys Ltd**, where I turn raw data into actionable insights that support business growth and decision-making.
...
- **Data Visualization**
- **End-to-end data projects** from raw datasets to deployed models

I enjoy solving real-world problems using data and building scalable, interpretable machine learning solutions.
...
- Improving model performance & interpretability  
- Applying ML to business and operational datasets  
...
- 💼 **Role:** Data Analyst at Two Hungry Boys Ltd  
- 💻 **GitHub:** You’re already here 🙂
- [![email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:yaswanthmullaguri@gmail.com) 

---

⭐ If you find my projects useful, feel free to **star** the repository and connect!


---
[![](https://visitcount.itsvg.in/api?id=yaswanth9491&icon=0&color=0)](https://visitcount.itsvg.in)
